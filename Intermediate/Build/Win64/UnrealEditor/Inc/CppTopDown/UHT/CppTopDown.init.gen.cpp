	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_CppTopDown()
	{
		if (!Z_Registration_Info_UPackage__Script_CppTopDown.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_CppTopDown_OnItemAdded__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_CppTopDown_OnItemRemoved__DelegateSignature,
			};
